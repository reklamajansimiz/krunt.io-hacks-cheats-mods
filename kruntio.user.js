// ==UserScript==
// @name         Krunt.io AIMBOT - Kruntio Hacks - Best Krunt Cheat 2019 to 2020
// @description  Kruntio Mods Features: Aimbot, Show Players, ESP, Auto Aim, Firebot, FPS, Adblock
...
// @updateURL    https://io-mods.com/mods/kruntio.user.js
// @downloadURL  https://io-mods.com/mods/kruntio.user.js
// @grant        GM_setValue
// @grant        GM_getValue
// @match        *://krunt.io/*
// @match        *iogames.space/*
...
text += '<a href="http://'+value+'" target="_blank" style="'+ministyler+'">'+value2+' <font color="#555555">-</font></a>';
    ...
    //ozellikler
    var fts = ["Auto Aim","Aimbot","Firebot","Speed Hack","Heal Hack","Show Players","Auto Fire","Anti Lag","Anti Ads","ESP","Auto Skin"];
...
//degisenkisimlar
$('.seoGroup').append('<div style="'+this.st.formstyle+'"><div class="option1"></div></div>');
$('#ytPanel').html('<div style="'+this.st.fpsstyle+'" id="fps" class="fps">');
$('#main').append('<hr><div class="list1"></div>');
...
document.getElementById("main").appendChild(styleSelect);
...
document.getElementById("main").appendChild(stylerSelect);
